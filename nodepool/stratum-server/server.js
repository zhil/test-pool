...
var Stratum = require('node-stratum-pool');
...
var pool = Stratum.createPool({
    ...
    "address": "QagJ8BsAiRbeDqF8Qrv4snwupPE2vQddQ4", //Address to where block rewards are given
    ...
    "ports": {
        "3333": { //A port for your miners to connect to
            "diff": 0.0000003, //the pool difficulty for this port
        ...
        "3334": { //Another port for your miners to connect to, this port does not use varDiff
            "diff": 0.00001 //The pool difficulty
        }
    },
